...
user = raw_input("Torijeanine@gmail.com: ")
passwfile = "psw.list"
...
for password in passwfile:
	try:
		...
		print (bcolors.FAIL + "Password Incorrect: %s" % password + bcopasswfile = open(passwfile, "r")lors.ENDCpasswfile = open(passwfile, "r"))
